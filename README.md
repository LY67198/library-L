...
> **Phase 4.1 已完成** — GET /api/v1/profile REST 端点，4 tests passed。
> **最近更新** — 前端强制认证（登录/注册拦截）+ 纯问候语意图分类修复。
...
- **Phase 4.1** ✅ — GET /api/v1/profile REST 端点
- **修复** ✅ — 前端强制认证（全局导航守卫 + 注册功能）+ 纯问候语意图分类优化
